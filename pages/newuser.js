    ...
    <Layout>
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-coffee">
          Crear <span className="text-brand-600">Usuario</span>
        </h1>
        <button
          type="button"
          onClick={() => router.back()}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 px-3 py-2 pr-12 text-sm focus:ring-1 focus:ring-brand-500"
              {...formik.getFieldProps('password')}
            />
            <button
              type="button"
              onClick={() => setShowPwd((v) => !v)}
              className="absolute right-2 top-8 text-xs text-gray-600 hover:text-coffee"
